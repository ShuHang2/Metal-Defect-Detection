...
class GPU_Detector:
    ...
    def camera_worker(self):
        ...
        def handle_frame(frame):
            ...
            cv2.putText(frame, f"CAPTURE FPS: {shared_realtime_fps:.1f}", (20, 95),
                ...
                <div class="video-section">
                    ...
                    <div class="status-bar">
                        <div class="status-card">
                            <div class="status-label">采集帧率</div>
                            <div id="transferFps" class="status-value">--</div>
                        </div>
                        <div class="status-card">
                            <div class="status-label">采集尺寸</div>
...
def apply_runtime_args():
    ...
    parser.add_argument("--source", default=CAMERA_SOURCE, help="摄像头源，默认0表示本地电脑摄像头")
...
if __name__ == '__main__':
    ...
    print("\n" + "="*60)
    print("GPU 本地摄像头工业质检台启动完毕！")
    print(f"本地摄像头源: {CAMERA_SOURCE}")
